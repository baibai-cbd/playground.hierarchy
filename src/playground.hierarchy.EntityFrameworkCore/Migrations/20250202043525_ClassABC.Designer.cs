...
namespace playground.hierarchy.Migrations
{
    ...
    [Migration("20250202043525_ClassABC")]
    partial class ClassABC
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("playground.hierarchy.ClassA", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppClassAs", (string)null);
                });

            modelBuilder.Entity("playground.hierarchy.ClassB", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppClassBs", (string)null);
                });

            modelBuilder.Entity("playground.hierarchy.ClassC", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppClassCs", (string)null);
                });
            ...
            modelBuilder.Entity("playground.hierarchy.ClassB", b =>
                {
                    b.HasOne("playground.hierarchy.ClassA", null)
                        .WithMany("Bs")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("playground.hierarchy.ClassC", b =>
                {
                    b.HasOne("playground.hierarchy.ClassB", null)
                        .WithMany("Cs")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
